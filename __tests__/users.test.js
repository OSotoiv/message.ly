...
describe("Test User class", function () {
  ...
  test("can get", async function () {
    // this test was failing due to last_login_at being null. the original test expected a date.
    //if you want the last_login_at to not be null you will need to update teh last_login when registering;
    let u = await User.get("test");
    expect(u).toEqual({
      username: "test",
      first_name: "Test",
